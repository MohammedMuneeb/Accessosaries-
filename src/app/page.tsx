import { ArrowRight, Github, Sparkles, Database, Layout, Shield } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <main className="flex-1 pt-32 px-8">
        ...
        {/* Features Grid */}
        <section id="features" className="max-w-6xl mx-auto py-32 grid md:grid-cols-3 gap-8">
